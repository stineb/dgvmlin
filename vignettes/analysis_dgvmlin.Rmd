...
df <- filnams |> 
  ...
  mutate(cmd_npp_units = paste(here("src/get_tot_ann.sh"), filn_npp, dir)) |> 
  
  ## create CDO command to take mean across years at simulation start and end
  mutate(cmd_cVeg    = paste(here("src/proc_trendy_soc_biomass.sh"), filn_cVeg,    dir, startyear_init,     endyear_init),
         cmd_cSoil   = paste(here("src/proc_trendy_soc_biomass.sh"), filn_cSoil,   dir, startyear_init,     endyear_init),
         cmd_npp     = paste(here("src/proc_trendy_soc_biomass.sh"), filn_npp_ANN, dir, startyear_npp_init, endyear_npp_init),
         cmd_cLeaf   = paste(here("src/proc_trendy_soc_biomass.sh"), filn_cLeaf,   dir, startyear_init,     endyear_init),
         cmd_cWood   = paste(here("src/proc_trendy_soc_biomass.sh"), filn_cWood,   dir, startyear_init,     endyear_init),
         cmd_cRoot   = paste(here("src/proc_trendy_soc_biomass.sh"), filn_cRoot,   dir, startyear_init,     endyear_init),
         cmd_dcSoil  = paste(here("src/proc_trendy_dsoc.sh"),        filn_cSoil,   dir),
         cmd_dcVeg   = paste(here("src/proc_trendy_dsoc.sh"),        filn_cVeg,    dir),
         cmd_dcLeaf  = paste(here("src/proc_trendy_dsoc.sh"),        filn_cLeaf,   dir),
         cmd_dcWood  = paste(here("src/proc_trendy_dsoc.sh"),        filn_cWood,   dir)
         ) |> 
