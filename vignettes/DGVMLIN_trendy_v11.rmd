...
mean_map <- ggplot() +
  ...
  theme_void() +
  labs(
    title = expression(paste(italic(L)[NPP/GPP],'  as Mean across models')) 
  )
...
sd_map <- ggplot() +
  ...
  theme_void() +
  labs(
    title = expression(paste(italic(L)[NPP/GPP],'  as SD across models')) 
  )
