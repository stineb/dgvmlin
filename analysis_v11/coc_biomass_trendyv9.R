...
setwd("~/E/RA/DGVM_density_plot/trendy_v9")
# filnams <- read_csv( "filnams_trendy_v8_S1.csv" ) %>% 
filnams <- read_csv( "filnams_trendy_v9_S1.csv" ) %>% 
...
df <- filnams %>% 
  ...
  mutate(dir = paste0("~/E/RA/DGVM_density_plot/trendy_v9/")) %>% 
  ...
  ## get starting year
  left_join(read_csv("~/E/RA/DGVM_density_plot/trendy_v9/startyear_trendy_v9_S1.csv"), by = "modl") %>% 
  ...
  mutate(cmd_npp_units = paste("~/E/RA/DGVM_density_plot/trendy_v9/get_tot_ann.sh", filn_npp, dir)) %>% 
  
  ## create CDO command to take mean across years at simulation start and end
  mutate(cmd_cVeg  = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_soc_biomass.sh", filn_cVeg,  dir, startyear_init, endyear_init),
         cmd_cSoil = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_soc_biomass.sh", filn_cSoil, dir, startyear_init, endyear_init),
         cmd_npp   = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_soc_biomass.sh", filn_npp,  dir, startyear_npp_init, endyear_npp_init),
         cmd_cLeaf = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_soc_biomass.sh", filn_cLeaf, dir, startyear_init, endyear_init),
         cmd_cWood = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_soc_biomass.sh", filn_cWood, dir, startyear_init, endyear_init),
         cmd_cRoot = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_soc_biomass.sh", filn_cRoot, dir, startyear_init, endyear_init),
         cmd_dcSoil = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_dsoc.sh", filn_cSoil, dir),
         cmd_dcVeg  = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_dsoc.sh", filn_cVeg,  dir),
         cmd_dcLeaf  = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_dsoc.sh", filn_cLeaf,  dir),
         cmd_dcWood  = paste("~/E/RA/DGVM_density_plot/trendy_v9/proc_trendy_dsoc.sh", filn_cWood,  dir)
  ) %>% 
